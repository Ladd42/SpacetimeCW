...
$iteminfo2=mysqli_query($mysqli, $iteminfo) or die ("Could not get player stats");
...
$itembought = "INSERT into inventory(ID, name, stats, statadd, randid, type) VALUES ('$userid, $name, $stats, $statadd', $randid2, $type)";
